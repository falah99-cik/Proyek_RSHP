    ...
    <div class="form-page-container">
        <div class="form-card">
            <header class="form-header">
                <h1 class="form-title">Edit Ras Hewan</h1>
                <p class="form-subtitle">Perbarui informasi ras hewan.</p>
            </header>

            <form action="{{ route('admin.ras-hewan.update', $rasHewan->idras_hewan) }}" method="POST" class="form-content">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon-wrapper">
                        ...
                        <input type="text" class="form-input @error('nama_ras') is-invalid @enderror" 
                               id="nama_ras" name="nama_ras" value="{{ old('nama_ras', $rasHewan->nama_ras) }}" required>
                    </div>
                    @error('nama_ras')
                        <span class="error-text">{{ $message }}</span>
                    @enderror
